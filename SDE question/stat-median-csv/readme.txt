...
4. Write a method, Stats::computeMedians, that computes the medians
   of task scores. If there is an odd number of tasks (data columns),
   the median is simply the middle value of all values taken in sorted
   order. If there is an even number of tasks (data columns), the
...
http://www.softwaredevelopercertification.com/sdc-pilot-exam/solution-demos#TOC-Stat-Median
or as stat-median-csv.html in the "Solution Demonstration Videos"
